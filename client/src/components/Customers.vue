<template>
    <div>
        <img src="@/assets/Customers.png" width=750px heigth=150px alt="Customers">
        ...
        <b-table :items="customers" :fields="fields" :select-mode="selectMode" :filter="filter" striped responsive="sm"
