<template>
    <div>
        ...
        <b-form-input v-model="invoice.customerFirstName" placeholder="Customer First Name" id="customerFirstName"></b-form-input>
        <b-form-input v-model="invoice.customerLastName" placeholder="Customer Last Name" id="customerLastName"></b-form-input>
        <b-form-input v-model="invoice.customerPhoneNumber" placeholder="Customer Phone Number" id="customerPhoneNumber"></b-form-input>


        <b-form-select
            v-model="invoice.productName"
            :options="products"
            class="mb-3"
        ...
        <b-form-spinbutton v-model="invoice.productQuantity" id="sb-inline" placeholder="--" inline @change="findProductTotal"></b-form-spinbutton>
        <b-form-input v-model="productTotal" id="productTotal" disabled></b-form-input>

        <b-form-select
            v-model="invoice.serviceName"
            :options="services"
            class="mb-3"
