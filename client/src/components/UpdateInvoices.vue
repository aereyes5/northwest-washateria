<template>
    <div>
        <b-form @submit.prevent="updateInvoice">
            ...
            <b-form-input v-model="invoice.customerFirstName" placeholder="Enter First Name" id="customerFirstName"></b-form-input>
            <b-form-input v-model="invoice.customerLastName" placeholder="Enter First Name" id="customerLastName"></b-form-input>
            ...
            <b-form-input v-model="invoice.productPrice" placeholder="Enter First Name" id="productPrice"></b-form-input>
            ...
            <b-form-input v-model="invoice.servicePrice" placeholder="Enter First Name" id="servicePrice"></b-form-input>
            <b-form-input v-model="invoice.totalPrice" placeholder="Enter First Name" id="totalPrice"></b-form-input>
            <b-form-input v-model="invoice.paymentMethod" placeholder="Enter First Name" id="paymentMethod"></b-form-input>
            <b-button variant="primary" type="submit">Submit</b-button>
        </b-form>
        <b-button v-bind:to="'Invoices'" variant="primary">Back</b-button>
    </div>
</template>
